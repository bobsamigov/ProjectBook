  ...
  <div class="flex justify-center mt-5">
    ...
    <nav aria-label="Page navigation example">
      <ul class="inline-flex -space-x-px">
        ...
        <li>
          <a href="#"
            class="px-3 py-2 leading-tight text-blue-600 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">1</a>
        </li>
        <li>
          <a href="#"
        ...
        <li>
          <a href="#" aria-current="page"
            class="px-3 py-2 text-gray-500 border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text- dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
        </li>
        <li>
          <a href="#"
